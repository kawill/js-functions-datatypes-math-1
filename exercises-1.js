...
var getAverageTime = function(person) {
    ...
    sum = (person.finishingTime1 + person.finishingTime2 + person.finishingTime3 + person.finishingTime4 + person.finishingTime5);
    return sum / 5;
    // ... return ...
}
...
function getSumOfAccounts(account) {
    "use strict";
    account.sum = (account.savings + account.retirement + account.checking);
    return account.sum; // return ...
}
